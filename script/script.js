const skillName = ['HTML-5','CSS-3','JavaScript','C++','Python','Flask']
const skillImg = ['/images/html5.png','/images/css-3.png','/images/Javascript.png','/images/cpp.png','/images/python.png','/images/flask.png']
const skillcol = ['#FFA500','#2196F3','#F7DF1E','#004481','#34709F','#eeeeee']
const skillLevel = ['ADVANCE','INTERMEDIATE','INTERMEDIATE','Advance','Intermediate','BASIC']
const skillVal = [90,85,75,93,85,90]
